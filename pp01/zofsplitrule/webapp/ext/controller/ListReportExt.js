    ...
    return {
        ...
        openUploadDialog: function () {
            ...
            Fragment.load({
                ...
                // binding attachment path
                 var oUploadSet = sap.ui.getCore().byId("idUploadSet");
                 var sPath = "Attach>/A_DocumentInfoRecordAttch(DocumentInfoRecordDocType='" + "SAT" +
                     "',DocumentInfoRecordDocNumber='" + "PP013" + "',DocumentInfoRecordDocVersion='" +
                     "00" + "',DocumentInfoRecordDocPart='" + "000" + "')";
                 oUploadSet.bindElement(sPath);
            }.bind(this));
        },
